...
CREATE TABLE `calculo` (
  ...
  `mes_calculo` varchar(8) DEFAULT NULL,
  `quinzena` varchar(1) DEFAULT NULL,
  `quantidade_producao` varchar(8) DEFAULT NULL,
  `quantidade_enrolacao` varchar(8) DEFAULT NULL,
  `calculo` varchar(8) DEFAULT NULL,
  `passou` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
